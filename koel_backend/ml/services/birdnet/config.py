...
# MODEL_PATH: str = "checkpoints/V2.4/BirdNET_GLOBAL_6K_V2.4_Model_FP32.tflite" # default model
MODEL_PATH: str = "checkpoints/V2.4/CustomClassifier03.tflite"
MDATA_MODEL_PATH: str = "checkpoints/V2.4/BirdNET_GLOBAL_6K_V2.4_MData_Model_V2_FP16.tflite"
# LABELS_FILE: str = "checkpoints/V2.4/BirdNET_GLOBAL_6K_V2.4_Labels.txt" # default model labels
LABELS_FILE: str = "checkpoints/V2.4/CustomClassifier03_Labels.txt"
